...
public class SmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPatchAccess().getPtAssignment_0(), "rule__Patch__PtAssignment_0");
			...
			builder.put(grammarAccess.getLightAccess().getPAssignment_10(), "rule__Light__PAssignment_10");
