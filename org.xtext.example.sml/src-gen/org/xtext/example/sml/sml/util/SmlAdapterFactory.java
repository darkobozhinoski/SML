...
public class SmlAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SmlSwitch<Adapter> modelSwitch =
    new SmlSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseDefinition1(Definition1 object)
      {
        return createDefinition1Adapter();
      }
      @Override
      public Adapter caseDefinition2(Definition2 object)
      {
        return createDefinition2Adapter();
      }
      @Override
      public Adapter caseDefinition3(Definition3 object)
      {
        return createDefinition3Adapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.sml.sml.Definition1 <em>Definition1</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDefinition1Adapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.sml.sml.Definition2 <em>Definition2</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDefinition2Adapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.xtext.example.sml.sml.Definition3 <em>Definition3</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDefinition3Adapter()
  {
    return null;
  }
