...
public class SmlPackageImpl extends EPackageImpl implements SmlPackage
{
   ...
   * @generated
   */
  private EClass definition1EClass = null;
   ...
   * @generated
   */
  private EClass definition2EClass = null;
   ...
   * @generated
   */
  private EClass definition3EClass = null;
   ...
   */
  @Override
  public EAttribute getElement_It()
  {
   ...
   */
  @Override
  public EClass getDefinition1()
  {
    return definition1EClass;
  }
   ...
   */
  @Override
  public EReference getDefinition1_Referencepoint()
  {
    return (EReference)definition1EClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getDefinition1_Dimensions()
  {
    return (EReference)definition1EClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EClass getDefinition2()
  {
    return definition2EClass;
  }
   ...
   */
  @Override
  public EReference getDefinition2_Point()
  {
    return (EReference)definition2EClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getDefinition3()
  {
    return definition3EClass;
  }
   ...
   */
  @Override
  public EAttribute getDefinition3_Ax()
  {
    return (EAttribute)definition3EClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getDefinition3_R()
  {
    return (EReference)definition3EClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(elementEClass, ELEMENT__IT);
    ...
    createEAttribute(lightEClass, LIGHT__IT);
    ...
    definition1EClass = createEClass(DEFINITION1);
    createEReference(definition1EClass, DEFINITION1__REFERENCEPOINT);
    createEReference(definition1EClass, DEFINITION1__DIMENSIONS);

    definition2EClass = createEClass(DEFINITION2);
    createEReference(definition2EClass, DEFINITION2__POINT);

    definition3EClass = createEClass(DEFINITION3);
    createEAttribute(definition3EClass, DEFINITION3__AX);
    createEReference(definition3EClass, DEFINITION3__R);
  ...
  public void initializePackageContents()
  {
    ...
    definition1EClass.getESuperTypes().add(this.getRegionDefinition());
    definition2EClass.getESuperTypes().add(this.getRegionDefinition());
    definition3EClass.getESuperTypes().add(this.getRegionDefinition());
    ...
    initEAttribute(getElement_It(), ecorePackage.getEString(), "it", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLight_It(), ecorePackage.getEString(), "it", null, 0, 1, Light.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(definition1EClass, Definition1.class, "Definition1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDefinition1_Referencepoint(), this.getPosition(), null, "referencepoint", null, 0, 1, Definition1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDefinition1_Dimensions(), this.getDimension(), null, "dimensions", null, 0, 1, Definition1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(definition2EClass, Definition2.class, "Definition2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDefinition2_Point(), this.getPosition(), null, "point", null, 0, -1, Definition2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(definition3EClass, Definition3.class, "Definition3", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDefinition3_Ax(), ecorePackage.getEString(), "ax", null, 0, 1, Definition3.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDefinition3_R(), this.getRange(), null, "r", null, 0, 1, Definition3.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
