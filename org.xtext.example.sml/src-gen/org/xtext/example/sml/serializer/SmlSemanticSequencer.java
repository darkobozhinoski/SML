...
public class SmlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SmlPackage.eINSTANCE)
			...
			case SmlPackage.COORDINATE3_D:
				...
				return; 
			case SmlPackage.DEFINITION1:
				sequence_Definition1(context, (Definition1) semanticObject); 
				return; 
			case SmlPackage.DEFINITION2:
				sequence_Definition2(context, (Definition2) semanticObject); 
				return; 
			case SmlPackage.DEFINITION3:
				sequence_Definition3(context, (Definition3) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     RegionDefinition returns Definition1
	 *     Definition1 returns Definition1
	 *
	 * Constraint:
	 *     ((referencepoint=Position dimensions=Dimension) | dimensions=Dimension)?
	 */
	protected void sequence_Definition1(ISerializationContext context, Definition1 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     RegionDefinition returns Definition2
	 *     Definition2 returns Definition2
	 *
	 * Constraint:
	 *     (point+=Position point+=Position*)
	 */
	protected void sequence_Definition2(ISerializationContext context, Definition2 semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     RegionDefinition returns Definition3
	 *     Definition3 returns Definition3
	 *
	 * Constraint:
	 *     (ax=Axis r=Range)
	 */
	protected void sequence_Definition3(ISerializationContext context, Definition3 semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SmlPackage.Literals.DEFINITION3__AX) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SmlPackage.Literals.DEFINITION3__AX));
			if (transientValues.isValueTransient(semanticObject, SmlPackage.Literals.DEFINITION3__R) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SmlPackage.Literals.DEFINITION3__R));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDefinition3Access().getAxAxisParserRuleCall_1_0(), semanticObject.getAx());
		feeder.accept(grammarAccess.getDefinition3Access().getRRangeParserRuleCall_3_0(), semanticObject.getR());
		feeder.finish();
	}
