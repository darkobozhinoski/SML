...
public class SmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDefinitionOneAccess().getGroup(), "rule__DefinitionOne__Group__0");
			builder.put(grammarAccess.getDefinitionOneAccess().getGroup_0(), "rule__DefinitionOne__Group_0__0");
			builder.put(grammarAccess.getDefinitionOneAccess().getGroup_1(), "rule__DefinitionOne__Group_1__0");
			...
			builder.put(grammarAccess.getDefinitionOneAccess().getReferencepointAssignment_0_1(), "rule__DefinitionOne__ReferencepointAssignment_0_1");
			builder.put(grammarAccess.getDefinitionOneAccess().getDimensionsAssignment_1_1(), "rule__DefinitionOne__DimensionsAssignment_1_1");
			builder.put(grammarAccess.getDefinitionTwoAccess().getPointAssignment_6(), "rule__DefinitionTwo__PointAssignment_6");
