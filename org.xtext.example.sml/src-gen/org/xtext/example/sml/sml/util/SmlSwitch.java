...
public class SmlSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        Definition1 definition1 = (Definition1)theEObject;
        T result = caseDefinition1(definition1);
        if (result == null) result = caseRegionDefinition(definition1);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmlPackage.DEFINITION2:
      {
        Definition2 definition2 = (Definition2)theEObject;
        T result = caseDefinition2(definition2);
        if (result == null) result = caseRegionDefinition(definition2);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case SmlPackage.DEFINITION3:
      {
        Definition3 definition3 = (Definition3)theEObject;
        T result = caseDefinition3(definition3);
        if (result == null) result = caseRegionDefinition(definition3);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Definition1</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Definition1</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDefinition1(Definition1 object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Definition2</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Definition2</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDefinition2(Definition2 object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Definition3</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Definition3</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDefinition3(Definition3 object)
  {
    return null;
  }
